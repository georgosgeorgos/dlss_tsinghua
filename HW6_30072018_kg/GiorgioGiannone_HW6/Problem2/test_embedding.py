...
if __name__ == "__main__":
    ...
    entity2id = readfile("../Problem1/data/entity2id.txt")
    relation2id = readfile("../Problem1/data/relation2id.txt")

    entity2id = {i[0]: i[1] for i in entity2id}
    relation2id = {i[0]: i[1] for i in relation2id}

    entity2vec = readfile("../Problem1/entity2vec.txt", False)
    relation2vec = readfile("../Problem1/relation2vec.txt", False)
